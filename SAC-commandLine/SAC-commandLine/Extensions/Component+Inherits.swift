...
extension Component {
    ...
    func isComponentView(otherComponents: [Component]) -> Bool {
        ...
        return inheritsFrom(types: NativeTypes.views, otherComponents: otherComponents)
    }
    
    func isComponentController(otherComponents: [Component]) -> Bool {
        // Check if inherits from controllers
        return inheritsFrom(types: NativeTypes.controllers, otherComponents: otherComponents)
    }
